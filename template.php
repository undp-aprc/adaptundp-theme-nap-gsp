...
function nap_preprocess_page(&$variables) {
    ...
    if ($variables['node']) {
        ...
        $function = 'nap_preprocess_page__'.$variables['type'];
...
function nap_page_alter(&$page) {
    ...
    $page['header']['nap_theme_blocks_header']['variables']['menus'][] = $page['menu_1'];
    $page['header']['nap_theme_blocks_header']['variables']['menus'][] = $page['menu_2'];
    $page['header']['nap_theme_blocks_header']['variables']['menus'][] = $page['menu_3'];
...
function nap_js_alter(&$javascript) {
...
function nap_preprocess_node__project(&$variables) {
...
function nap_preprocess_node__page(&$variables) {
    $variables['content']['links']['#theme'] = 'read_more_button';
}

function nap_preprocess_node__news(&$variables) {
...
function nap_preprocess_page__project(&$variables) {
    kpr($variables);
}

function nap_preprocess_taxonomy_term(&$variables) {
...
function nap_date_nav_title($params) {
...
function nap_menu_local_task($variables) {
...
function nap_menu_local_tasks(&$variables) {
    $output = '';
...
/* theme_image_style() */
function nap_image_style($variables) {
...
function nap_textfield($variables) {
    $element = $variables['element'];
...
function nap_password($variables) {
    $element = $variables['element'];
...
function nap_textarea($variables) {
    $element = $variables['element'];
